...
if (contar2 == 1) { // inicializa variables para cuenta (2 horas = 7200000 milisegundos)
  tiempoinicio = millis();
  contando = 1;  
...
if (contar4 == 1) { // inicializa variables para cuenta (4 horas = 14400000 milisegundos)
  tiempoinicio = millis();
  contando = 1;  
...
if (contar6 == 1) { // inicializa variables para cuenta (6 horas = 21600000 milisegundos)
  tiempoinicio = millis();
  contando = 1;  
